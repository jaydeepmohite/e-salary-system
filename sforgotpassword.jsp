...
<form action="sforgotpassword.jsp?chk=1" method="post" name="myForm">
<table><tr><td>
...
try
{
	...
	if("1".equals(chk))
	{
		...
		{
			response.sendRedirect("sforgotpassword.jsp?chk=3");
		}
		if(count>0)
		{
			
			Statement st1=cn.createStatement();
			ResultSet r1=st1.executeQuery("select question,answer from school_login where s_username='"+usr+"'");
			r1.next();
			...
			if(qus.equals(ques) && ans1.equals(ans))
			{
				...
				int y=st2.executeUpdate("update school_login set s_password='"+pass2+"' where s_username='"+usr+"'");
				if(y>0)
				{
